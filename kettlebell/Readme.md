...
- 補助運動として[インディアンクラブ](indian.md)を[開始](https://twitter.com/seki/status/1551128186045734914)。重さは２ポンド。まずはルメール法の基本動作（フロントサークル、バックサークル、サイドリストサークル、フロントリストサークルとそれぞれの逆回転）を習熟する。天井にぶつかるフロントサークルは外で、それ以外は部屋の中で窓の反射を見ながら。
